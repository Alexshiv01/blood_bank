...
<div class="container-fluid red-background size">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h1 class="text-center">Requestors</h1>
            <hr class="white-bar">
        </div>
    ...
    <a href="{{ route('requests.create') }}" class="btn btn-primary2" role="button" aria-pressed="true">Blood Request
    </a>
        ...
        @foreach ($bloodreqs as $donor)
            <div class="col-md-3 col-sm-12 col-lg-3 donors_data ">
                ...
                <div class="single-service">
                    ...
                    {{-- <h2> <span class="text-primary">Donate</span></h2> --}}
                    <a href="#!" class="btn btn-primary2" role="button" aria-pressed="true">Donate Blood
                    </a>
                </div>
            </div>
            {{-- // --}}
